 ...
 *
 */
public class ExampleAdapterLibrary implements ExtensionDefinition {
	...
	public InputStream getDefinitionAsStream() {
		return getClass().getClassLoader().getResourceAsStream("com/dexels/navajo/example/adapter/adapters.xml");
	}
