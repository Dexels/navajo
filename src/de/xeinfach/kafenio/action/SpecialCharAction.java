...
public class SpecialCharAction extends StyledEditorKit.StyledTextAction {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8578272212339834347L;
	 ...
	 * 
	 * @param kafenio
	 *            the KafenioPanel to apply the changes to.
	 * @param actionName
	 *            the name of the SpecialCharAction.
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (editor != null) {
			...
			UserInputCharacterDialog uidInput = new UserInputCharacterDialog(
					parentKafenioPanel,
					getString("InsertCharacterDialogTitle"), true);
