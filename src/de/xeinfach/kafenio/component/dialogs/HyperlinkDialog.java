...
public class HyperlinkDialog extends JDialog implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1051440158527213463L;
	 ...
	 */
	public HyperlinkDialog(KafenioPanel kafenio, String currentUrl,
	...
	public void init() {
		...
		targets = new Vector(Arrays.asList(new String[] { "", "_new", "_blank",
				"_parent", "top" }));
		...
		controls = new Object[] {
				new JLabel(getString("InsertAnchorTextField")), nameField,
				new JLabel(getString("InsertAnchorURLField")), urlField,
				insertServerUrlButton,
				new JLabel(getString("InsertAnchorTargetField")), targetField };

		if (Utils.checkNullOrEmpty(url) != null) {
			options = new String[] { getString("InsertAnchorInsertLinkButton"),
		...
		option = JOptionPane.showOptionDialog(parentKafenio, controls,
				getString("AnchorDialogTitle"), JOptionPane.DEFAULT_OPTION,
	...
	/**
	 * @return returns the id of the action as specified using the constants in
	 *         this class.
	 */
