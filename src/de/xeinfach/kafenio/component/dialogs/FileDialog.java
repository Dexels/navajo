...
public class FileDialog extends JDialog implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8323519033672897507L;
	...
	/**
	 * constructs a new FileDialog. the List displays the names of the
	 * NameValuePair-Objects in the given Vector.
	 * 
	 * @param kafenioPanel
	 *            a reference to a KafenioPanel instance.
	 * @param newFileDir
	 *            Directory-prefix
	 * @param newFileList
	 *            Vector of NameValuePair-Objects containing name/value-pairs.
	 * @param title
	 *            window title
	 * @param modal
	 *            boolean value.
	 */
	public FileDialog(KafenioPanel kafenioPanel, String newFileDir,
			Vector newFileList, String title, boolean modal) {
		super(kafenioPanel.getFrame(), title, modal);
		if (newFileDir != null && !newFileDir.equals("")) {
	...
	/**
	 * constructs a new FileDialog. the List displays the names of the Strings
	 ...
	 */
	public FileDialog(KafenioPanel kafenioPanel, String newFileDir,
			String[] newFileList, String title, boolean modal) {
			...
			public void valueChanged(ListSelectionEvent e) {
				if (!e.getValueIsAdjusting()) {
					...
					if (!sm.isSelectionEmpty()) {
						selectedFile = ((NameValuePair) files.get(sm
								.getMinSelectionIndex())).getValue();
					}
				}
			}
		});
