...
//        System.err.println(ascending?"Ascending":"Descending");
  ...
  public MouseAdapter addMouseListenerToHeaderInTable(JTable table) {
...
//                    ascending = (shiftPressed == 0);
        ...
        for (int i = 0; i < columnModel.getColumnCount(); i++) {
          ...
          if (cth!=null) {
            cth.setSortingState(CustomTableHeaderRenderer.NONE);
            cth.repaint();
          }
        ...
        cth.setSortingState(ascending ? CustomTableHeaderRenderer.ASCENDING :
