 ...
 */
class StateEditPart extends AbstractGraphicalEditPart 
...
protected void createEditPolicies() {
	...
	installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE, new GraphicalNodeEditPolicy() {
		...
		protected Command getConnectionCreateCommand(CreateConnectionRequest request) {
			StateElement source = (StateElement) getHost().getModel();
		...
		protected Command getReconnectSourceCommand(ReconnectRequest request) {
			...
			StateElement newSource = (StateElement) getHost().getModel();
		...
		protected Command getReconnectTargetCommand(ReconnectRequest request) {
			TransitionElement conn = (TransitionElement) request.getConnectionEditPart().getModel();
			StateElement newTarget = (StateElement) getHost().getModel();
			ConnectionReconnectCommand cmd = new ConnectionReconnectCommand(conn);
...
public void propertyChange(PropertyChangeEvent evt) {
	...
	if (StateElement.SIZE_PROP.equals(prop) || StateElement.LOCATION_PROP.equals(prop)) {
		refreshVisuals();
