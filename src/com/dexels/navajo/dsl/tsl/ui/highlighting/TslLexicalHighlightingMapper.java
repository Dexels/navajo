...
//		}
		...
		encountered = valueForAnyInString(tokenName, new String[]{"RULE_NAVASCRIPT_START","RULE_NAVASCRIPT_END","RULE_XMLHead","RULE_XMLComment","RULE_CDATA","RULE_SL_COMMENT","RULE_ML_COMMENT"});
		if(encountered) { 
