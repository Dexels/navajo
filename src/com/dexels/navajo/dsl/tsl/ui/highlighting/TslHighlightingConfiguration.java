...
public class TslHighlightingConfiguration implements
	...
	public void configure(IHighlightingConfigurationAcceptor acceptor) {
		...
		acceptor.acceptDefaultHighlighting(EXPR_DELIM_ID, "Expression delimiter", expressionDelimStyle());
		acceptor.acceptDefaultHighlighting(TML_INPUT, "TML Input", tmlInputStyle());
		acceptor.acceptDefaultHighlighting(KEYWORD_ID, "Keyword", keywordTextStyle());
		acceptor.acceptDefaultHighlighting(DEPRECATED_ID, "Deprecated", deprecatedStyle());
		acceptor.acceptDefaultHighlighting(LITERAL_ID, "Literal", literalStyle());
	}
