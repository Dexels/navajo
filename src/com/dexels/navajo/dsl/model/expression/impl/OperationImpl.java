 ...
 * <ul>
 *   <li>{@link com.dexels.navajo.dsl.model.expression.impl.OperationImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationImpl extends ExpressionImpl implements Operation {
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.OPERATION__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpressionPackage.OPERATION__TYPE:
				return getType();
		}
