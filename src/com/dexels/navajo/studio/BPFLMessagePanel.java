...
public class BPFLMessagePanel extends BaseStudioPanel {
    ...
    void jbInit() throws Exception {
        ...
        jPanel1.add(jLabel2, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(123, 22, 144, 0), 4, 0));
        jPanel1.add(nameField, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(123, 0, 144, 101), 169, 0));
        applyTemplate2();
    }
