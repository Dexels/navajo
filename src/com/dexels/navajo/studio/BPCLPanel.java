...
//    to do: add disabled and enabled feature
    ...
    if(!selectedNode.getTag().equals("")&&!selectedNode.isRoot()){
      ...
      if(tag.equals("message")){
        ...
        if(selectedNode.getAttribute("object")!=null && !selectedNode.getAttribute("object").equals("")){
          //an object map
...
//          addMapButton.setEnabled(false);
        ...
        else if(tmpNode.getTag().equals("property")|| tmpNode.getTag().equals("field") || tmpNode.getTag().equals("param")){
          addPropertyButton.setEnabled(false);
...
//          Util.debugLog("Got current node");
          ...
          if (tmpNode.getTag().equals("property") || tmpNode.getTag().equals("param")) {
            addExpressionButton.setEnabled(true);
          }
        }
...
//                rootPanel.showMsg("getCurrentNode main root Object ="+rootPanel.currentObject.getName());
        ...
        if(!haveSetRefContext){
          if(tmpNode.getTag().equals("property")||tmpNode.getTag().equals("message")){
            refIsProperty = true;
