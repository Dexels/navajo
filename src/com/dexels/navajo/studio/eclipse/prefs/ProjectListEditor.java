...
public class ProjectListEditor implements NavajoPluginResources {
...
//		fProjectsList.setViewerSorter(new CPListElementSorter());
	...
	private void updateProjectsList() {
		try {
			...
			List oldProjectsInCP = NavajoScriptPluginPlugin.getDefault().getProjectsInCP();
	...
	private void invokeForCompatibility(String methodName, List projects) {
		...
		try {
			...
			try {
			    ...
			    NavajoScriptPluginPlugin.log(ex);
			}
		}
