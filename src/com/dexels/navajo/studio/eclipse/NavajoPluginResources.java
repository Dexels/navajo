...
public interface NavajoPluginResources {

    public static final String WIZARD_PROJECT_TITLE = "New Navajo project";

    public static final String PREF_PAGE_SELECTALL_LABEL = "Select all";

    public static final String PREF_PAGE_UNSELECTALL_LABEL = "Unselect all";

    public static final String PREF_PAGE_PROJECTINCP_LABEL = "Add projects to Navajo classpath";

    public static final String PREF_PAGE_PROJECTINSOURCEPATH_LABEL = "Add projects to source path (So the Eclipse debugger will work)";

    public static final String PREF_PAGE_JVMSETTINGS_LABEL = "Set up the Java VM";

    public static final String PREF_PAGE_PARAMETERS_LABEL = "Add to JVM parameters";

    public static final String PREF_PAGE_JRE_LABEL = "JRE";

    public static final String PREF_PAGE_CLASSPATH_LABEL = "Classpath";

    public static final String PREF_PAGE_BOOTCLASSPATH_LABEL = "Boot classpath";
    ...
    //
    public static final String PREF_PAGE_ADDBUTTON_LABEL = "Add";

    public static final String PREF_PAGE_ADDDIRBUTTON_LABEL = "Directory";

    public static final String PREF_PAGE_ADDJARZIPBUTTON_LABEL = "Add jar/zip file";

    public static final String PREF_PAGE_REMOVEBUTTON_LABEL = "Remove";

    public static final String PREF_PAGE_UPDATEBUTTON_LABEL = "Update";

    public static final String PREF_PAGE_UPBUTTON_LABEL = "Up";

    public static final String PREF_PAGE_DOWNBUTTON_LABEL = "Down";
    ...
    //		
    public static final String PREF_PAGE_LIST_SEPARATOR = ";";
    ...
    //	
    public static final String PREF_PAGE_SERVERXML_LABEL = "Server.xml";

    public static final String PREF_PAGE_DEBUGMODE_LABEL = "Debug";

    public static final String PREF_PAGE_DEBUGMODE_KEY = "pref.page.debugmode.Key";
