...
//  showMsg("changeContentPane");
    ...
    DividerLocationOfTreePanel = this.getWidth() - verticalSplitPane.getDividerLocation();
    ...
    msgSplitDividerHeight = this.getHeight() - horizontalSplitPane.getDividerLocation();
  ...
  //first ask for confirmation...
    ...
    if (selection == JOptionPane.OK_OPTION) {
      ...
      if(j!=null){
        ...
        // this object is not yet initialize, probaly called from inside the constructor
      }
...
// coppy paste
  ...
  void setEditTitle(int i, boolean newEntry) {
    ...
    switch(i){
      case BPFLPANEL: editPanel.setTitle(""); //= 1;
      case BPCLPANEL: editPanel.setTitle(""); //     = 2;

    // bpfl panels
      case BPFLMESSAGE: editPanel.setTitle(prefix +"Message");//     = 11;
      break;
      case BPFLMETHODS: editPanel.setTitle(prefix +"Methods");//      = 12;
      break;
      case BPFLPROPERTY: editPanel.setTitle(prefix +"Property");//   = 13;
      break;

    // bpcl panels
      case BPCLEXPRESSION: editPanel.setTitle(prefix +"Expression");//= 21;
      break;
      case BPCLFIELD: editPanel.setTitle(prefix +"Field");      //= 22;
      break;
      case BPCLMAP: editPanel.setTitle(prefix +"Map");        //= 23;
      break;
      case BPCLMESSAGE: editPanel.setTitle(prefix +"Message");    //= 24;
      break;
      case BPCLOBJECT: editPanel.setTitle(prefix +"Object");     //= 25;
      break;
      case BPCLPROPERTY: editPanel.setTitle(prefix +"Property");   //= 26;
      break;
      case BPCLPARAM: editPanel.setTitle(prefix +"Param");   //= 27;
      break;
      default: editPanel.setTitle("????"); // unknown panel
