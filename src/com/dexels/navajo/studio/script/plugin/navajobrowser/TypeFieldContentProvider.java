...
//                if (Signature.getParameterCount(iff.getTypeSignature())>0) {
//                    sb.append(" (");
//                    String[] param = Signature.getParameterTypes(iff.getTypeSignature());
...
//                    	int arrayNest = Signature.getArrayCount(iff.getTypeSignature());
//                    	StringBuffer sbb = new StringBuffer(iff.()  Signature.getTypeVariable(iff.()) +" ("+type+")");
