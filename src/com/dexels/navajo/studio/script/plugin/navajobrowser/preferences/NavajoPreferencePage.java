...
public class NavajoPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    public void createFieldEditors() {
        addField(new PathEditor(P_NAVAJO_PATH, "&Path preference:", "Choose", getFieldEditorParent()));
        //		addField(
