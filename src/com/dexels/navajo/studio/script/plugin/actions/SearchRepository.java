	    ...
	    if (folder==null) {
            ...
            new Job("Looking for repositories"){
                ...
                protected IStatus run(IProgressMonitor monitor) {
                    ...
                    try {
                        ArrayList matches = NavajoScriptPluginPlugin.getDefault().searchForImplementingClasses((IProject)folder, NavajoScriptPluginPlugin.NAVAJO_REPOSITORY_INTERFACE,null);
                        System.err.println(matches.size()+ " repositories found.");
                        matches = NavajoScriptPluginPlugin.getDefault().searchForImplementingClasses((IProject)folder, NavajoScriptPluginPlugin.NAVAJO_ADAPTER_INTERFACE,null);
                        System.err.println(matches.size()+ " adapters found.");
                        matches = NavajoScriptPluginPlugin.getDefault().searchForExtendingClasses((IProject)folder, NavajoScriptPluginPlugin.NAVAJO_FUNCTION_CLASS,null);
