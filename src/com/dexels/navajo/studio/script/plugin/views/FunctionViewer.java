...
public class FunctionViewer extends BaseNavajoView {
    ...
    // @jve:decl-index=0:visual-constraint="27,46"
    ...
    private void createComposite2() {
        ...
        otherUsageLabel
                .setFont(new org.eclipse.swt.graphics.Font(org.eclipse.swt.widgets.Display.getDefault(), "Tahoma", 8, org.eclipse.swt.SWT.BOLD));
    ...
    public void createPartControl(Composite parent) {
        ...
        //        GridData gda = new GridData(GridData.FILL,
        ...
        //                NavajoScriptPluginPlugin.getDefault().insertIntoCurrentTextEditor("<expression
...
//            }
    ...
    private void restartExpressionRunner() {
        try {
            ...
            //                   return Status.OK_STATUS;
            //                }};
            Launch lll = NavajoScriptPluginPlugin.getDefault().runNavajoBootStrap("com.dexels.navajo.client.impl.NavajoExpressionRunner", true, iff.getProject(),
                    "", "", null,null, null);
