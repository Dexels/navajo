 ...
 * <ul>
 *   <li>{@link com.dexels.navajo.workflow.impl.TransitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.dexels.navajo.workflow.impl.TransitionImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link com.dexels.navajo.workflow.impl.TransitionImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link com.dexels.navajo.workflow.impl.TransitionImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link com.dexels.navajo.workflow.impl.TransitionImpl#getFrom <em>From</em>}</li>
...
public class TransitionImpl extends EObjectImpl implements Transition {
	...
	public void setTrigger(String newTrigger) {
		...
		trigger = newTrigger;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.TRANSITION__TRIGGER, oldTrigger, trigger));
	}
	...
	public void setUsername(String newUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.TRANSITION__USERNAME, oldUsername, username));
	}
	...
	public State getFrom() {
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WorkflowPackage.TRANSITION__FROM, oldFrom, from));
			}
		}
		return from;
	}
	...
	public void setFrom(State newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.TRANSITION__FROM, oldFrom, from));
	}
