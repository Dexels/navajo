...
public class MySqlResourceInstance implements JdbcResourceInstance {

	
	private DataSource source;
	private ResourceConfig config;
	private final static  Logger logger= LoggerFactory.getLogger(MySqlResourceInstance.class);
	@Override
