...
//			System.err.println("Differnt types detected. Not animatable: "+start.getClass()+" - "+end.getClass());
			return false;
		}
...
//		System.err.println("Other types detected. Not animatable: "+start.getClass()+" - "+end.getClass());
		return false;
	}
}
