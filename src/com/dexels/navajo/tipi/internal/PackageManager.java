...
//    titledBorder2 = new TitledBorder(BorderFactory.createEtchedBorder(Color.white, new Color(148, 145, 140)), "Required libraries:");
...
//    optionalList.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
