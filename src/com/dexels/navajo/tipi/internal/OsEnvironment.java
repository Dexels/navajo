...
/**
 * OSEnvironment class provides read only access to the operating system
 * environment variables. <BR>
 * 
 * Presently, it will obtain the environment variables for Windows 95/98/NT/2000
 * and Unix.
 * 
 * @author David J. Ward
 * 
...
public class OsEnvironment {
	...
	/**
	 * @return a Properties object containing the environment variables and
	...
	private static java.util.Properties getEnvironment() {
		...
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				// this occurs when there are newline characters in the
