...
public class TipiTransferHandler extends TransferHandler {
	...
	public boolean canImport(TransferSupport support) {
		...
		TipiDndManager manager = ((TipiDndCapable)support.getComponent()).getDndManager();
		
		Transferable transferable = support.getTransferable();
		try {
			TipiDraggable o = (TipiDraggable) transferable.getTransferData(TipiTransferable.getFlavor());
	...
	public boolean importData(TransferSupport support) {
		...
		TipiDndManager managerForDropSide = ((TipiDndCapable)support.getComponent()).getDndManager();
		try {
			TipiDraggable o = (TipiDraggable) transferable.getTransferData(TipiTransferable.getFlavor());
