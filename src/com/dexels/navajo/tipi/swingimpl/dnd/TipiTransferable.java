...
//			parentFla = myHandler.getParentHandler().
	...
	public static DataFlavor getFlavor() {
		return new DataFlavor(TipiDraggable.class,DataFlavor.javaJVMLocalObjectMimeType);
//		return new ActivationDataFlavor(TipiDraggable.class,DataFlavor.javaJVMLocalObjectMimeType,DataFlavor.javaJVMLocalObjectMimeType);
	}
}
