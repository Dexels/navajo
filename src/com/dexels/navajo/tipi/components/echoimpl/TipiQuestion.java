...
//          System.err.println("Property found!");
        ...
        o.addTipiEventListener(new TipiEventListener() {
          public boolean performTipiEvent(String eventtype, Map source,
              ...
              System.err.println("Updating question group....");
              updateQuestionGroup();
...
//      System.err.println("ID: "+myId);
  ...
  public void updateSubQuestions() {
    if (visibleCondition != null) {
      ((Component)getContainer()).setVisible(isRelevant());
...
//    }
      ...
      if (getContainer() instanceof Borderable) {
          Borderable bb = (Borderable)getContainer();
          if (b) {
//              bb.setBorder(new Border(5,new Color(20,200,20),Border.STYLE_DASHED));
            bb.setBorder(null);
        } else {
            bb.setBorder(new BorderEx(1,new Color(200,20,20),Border.STYLE_SOLID));
        }
        
    } else {
        System.err.println("NOT BORDERABLE!");
    }
//      GroupBox cc = (GroupBox)getContainer();
//          cc.setTitle(b?"Okidokie":msg);
//      
  }
...
//
    if (validationCondition != null) {
      ...
      if (o != null) {
          System.err.println("Validation result: "+o.value);
