...
public class TipiRichPanel extends TipiPanel {
	...
	myPanel.setLayout(gridBagLayout);
	  myPanel.add(actualPanel,new GridBagConstraints(0,0,1,1,1.0,1.0,GridBagConstraints.CENTER,GridBagConstraints.BOTH,insets,0,0));
	  return myPanel;
  }

	private void resetLayout() {
		gridBagLayout.setConstraints(actualPanel, new GridBagConstraints(0,0,1,1,1.0,1.0,GridBagConstraints.CENTER,GridBagConstraints.BOTH,insets,0,0));
