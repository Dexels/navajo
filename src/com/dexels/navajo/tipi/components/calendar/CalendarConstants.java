...
public class CalendarConstants {
  ...
  final static Color[] DEFAULT = {Color.decode("#7A9BF8"),Color.lightGray,Color.red,Color.black,Color.white,Color.decode("#002266"),Color.decode("#EEEEEE"),Color.black,Color.decode("#77FF77")};
  final static Color[] UNDERWORLD = {Color.decode("#0000FF"),Color.lightGray,Color.yellow,Color.white,Color.red,Color.decode("#440000"),Color.decode("#000000"),Color.white,Color.decode("#77FF77")};
  final static Color[] CONTRAST = {Color.blue, Color.black, Color.white, Color.black, Color.white, Color.lightGray,Color.white,Color.black,Color.decode("#77FF77")};
  final static Color[] RETRO = {Color.decode("#F86300"),Color.black,Color.yellow,Color.black,Color.white,Color.lightGray,Color.lightGray,Color.black,Color.decode("#33aa33")};
