 ...
 */
public class TipiSwingWrapLayout extends FlowLayout {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3134759106092838040L;
	/**
	 ...
	 * argument must be one of <code>WrappingFlowLayout</code>,
	 * <code>WrappingFlowLayout</code>, or <code>WrappingFlowLayout</code>.
	 * 
	 * @param align
	 *            the alignment value
	 */
