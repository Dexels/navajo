 ...
 * @version 1.0
 */
public abstract class TipiSwingMessageDataComponentImpl
    extends TipiMessageDataComponentImpl
...
public void loadData(final Navajo n, final String method) throws TipiException, TipiBreakException {
  	if (getContainer()!=null && getContainer() instanceof JComponent) {
			...
			runSyncInEventThread(new Runnable(){
				...
				public void run() {
					try {
						TipiSwingMessageDataComponentImpl.super.loadData(n, method);
...
protected void loadValues(final XMLElement values, final TipiEvent event) throws TipiException {
	runSyncInEventThread(new Runnable(){
		...
		public void run() {
			try {
				TipiSwingMessageDataComponentImpl.super.loadValues(values, event);
...
public void loadStartValues(final XMLElement element,final TipiEvent event) {
	runSyncInEventThread(new Runnable(){
		...
		public void run() {
				TipiSwingMessageDataComponentImpl.super.loadStartValues(element,event);
...
protected void doCallSetter(final Object component, final String propertyName, final Object param) {
	runSyncInEventThread(new Runnable(){
		public void run() {
			TipiSwingMessageDataComponentImpl.super.doCallSetter(component,propertyName,param);
		}});
}
