...
//      System.err.println("Instantiating from definition");
  ...
  public void performServiceList(String list, String tipiPath, TipiContext context, TipiEvent event) throws TipiException {
    if (list.indexOf(";") < 0) {
      try {
        performService(context, tipiPath, list,false,event,-1,null);
      }
  ...
  public void performService(TipiContext context, String service, TipiEvent event) throws TipiException, TipiBreakException {
    performService(context, "*", service,false,event,-1,null);
  }

  public void performService(TipiContext context, String tipiPath, String service, boolean breakOnError,TipiEvent event, long expirationInterval, String hostUrl) throws TipiException, TipiBreakException {
    /** @todo Tempory HACK!!! */
    tipiPath = "*";
//    System.err.println("Performing service: "+getPath());
    ...
    context.performTipiMethod(this, myNavajo, tipiPath, service,breakOnError,event,expirationInterval,hostUrl);
  }
