...
public class TipiPerformMethod extends TipiAction {
	public void execute(TipiEvent event) throws com.dexels.navajo.tipi.TipiException, com.dexels.navajo.tipi.TipiBreakException {
		...
		// System.err.println("\nPerformMethod. to service "+method.value+" my
		// event:
		// "+event.toString()+"\n**********************************************\n");
		...
		// myContext.performTipiMethod(null, myComponent.getNearestNavajo(),
		// destination,
		// method.value.toString(),breakOnError,event,expirationInterval,
		// hostUrl,username,password,keystore,keypass);
		// }
		// // use the closest navajo
		// else {
		// myContext.performTipiMethod(null,
		// NavajoFactory.getInstance().createNavajo(), destination,
		// method.value.toString(),breakOnError,event,expirationInterval,
		// hostUrl,username,password,keystore,keypass );
		// }
		// return;
		...
		// method.value.toString(),breakOnError,event,expirationInterval,hostUrl,username,password,keystore,keypass,null);
