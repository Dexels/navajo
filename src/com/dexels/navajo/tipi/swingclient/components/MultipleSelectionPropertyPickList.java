...
public final class MultipleSelectionPropertyPickList
    extends JPanel
...
//setBackground(Color.red);
    ...
    this.add(jScrollPane1, new GridBagConstraints(0, 0, 1, 2, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2),-1000, 0));
    jScrollPane1.getViewport().add(notSelectedList, null);
    this.add(jScrollPane2, new GridBagConstraints(2, 0, 1, 2, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), -1000, 0));
    jScrollPane2.getViewport().add(selectedList, null);
    this.add(selectButton, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
    this.add(deselectButton, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
  }
   ...
   *
   * @return Property
   * @todo Implement this com.dexels.navajo.swingclient.components.PropertyControlled method
   */
...
//      s.setSelected(true);
      try {
		myProperty.setSelected(s, true);
		} catch (NavajoException e1) {
		e1.printStackTrace();
	}
//      selectedModel.addElement(s);
//      deselectedModel.removeElement(s);
    }
