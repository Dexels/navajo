...
public class MaintainanceRequest extends Request {
  ...
  public static final String METHOD_NAVAJO_SHOWUSERS = METHOD_NAVAJO + "_showusers";
  public static final String METHOD_NAVAJO_SHOWPARAMETERS = METHOD_NAVAJO + "_showparameters";
  public static final String METHOD_NAVAJO_SHOWCONDITIONS = METHOD_NAVAJO + "_showconditions";
  public static final String METHOD_NAVAJO_ADD_USER = METHOD_NAVAJO + "_add_user";
  public static final String METHOD_NAVAJO_ADD_SERVICE = METHOD_NAVAJO + "_add_service";
  public static final String METHOD_NAVAJO_AUTHORISE = METHOD_NAVAJO + "_authorise";
  public static final String METHOD_NAVAJO_SHOW_AUTHORISED = METHOD_NAVAJO + "_show_authorised";
  public static final String METHOD_NAVAJO_ADD_DEFINITION = METHOD_NAVAJO + "_add_definition";
  public static final String METHOD_NAVAJO_DELETE_DEFINITION = METHOD_NAVAJO + "_delete_definition";
  public static final String METHOD_NAVAJO_ADD_VALUE = METHOD_NAVAJO + "_add_value";
  public static final String METHOD_NAVAJO_FIND_VALUE = METHOD_NAVAJO + "_find_value";
  public static final String METHOD_NAVAJO_EDIT_VALUE = METHOD_NAVAJO + "_edit_value";
  public static final String METHOD_NAVAJO_DELETE_VALUE = METHOD_NAVAJO + "_delete_value";
  public static final String METHOD_NAVAJO_SHOW_VALUES = METHOD_NAVAJO + "_show_values";
  public static final String METHOD_NAVAJO_DELETE_USER = METHOD_NAVAJO + "_delete_user";
  public static final String METHOD_NAVAJO_DELETE_SERVICE = METHOD_NAVAJO + "_delete_service";
  public static final String METHOD_NAVAJO_DELETE_AUTHORISATION = METHOD_NAVAJO + "_delete_authorisation";
  public static final String METHOD_NAVAJO_ADD_CONDITION = METHOD_NAVAJO + "_add_condition";
  public static final String METHOD_NAVAJO_SHOW_CONDITIONS = METHOD_NAVAJO + "_show_conditions";
  public static final String METHOD_NAVAJO_FIND_CONDITION = METHOD_NAVAJO + "_find_condition";
  public static final String METHOD_NAVAJO_EDIT_CONDITION = METHOD_NAVAJO + "_edit_condition";
  public static final String METHOD_NAVAJO_DELETE_CONDITION = METHOD_NAVAJO + "_delete_condition";
  public static final String METHOD_NAVAJO_SHOWLOG = METHOD_NAVAJO + "_showlog";
  public static final String METHOD_NAVAJO_SHOW_VIEW = METHOD_NAVAJO + "_show_view";
...
*/
                  ...
                  org.xml.sax.SAXException, NavajoException
  {
    ...
    boolean everyService = (allServices.getValue().equals("1")) ? true : false;
