	    ...
	    //NodeList list = n.getChildNodes();
            ...
            if (messageName.equals("error")) {
              ...
              switch (level) {
                ...
                case 3: fontSize = 2;break;
                case 4: fontSize = 1;break;
	      ...
	      for (i = 0; i < list.size(); i++) {
			...
			name = e.getName();
                        ...
                        length = e.getLength()+"";
                        String parameterName = messageName+Navajo.MESSAGE_SEPARATOR+name;
			...
			result.append("<BR>\n");
		       ...
		       value = e.getValue();
                    ...
                    } else if (e.getType().equals(Property.POINTS_PROPERTY)) {
                      //String image = "<IMG SRC=\"GraphServlet?width=200&height=200&message="+messageName+"&property="+e.getName()+"\"><BR><BR>";
                      //result.append(image);
                    }
