...
public class ServiceGroupPanel extends BaseNavajoPanel {
    ...
    void jbInit() throws Exception {
        ...
        centerPanel.add(NameField, new GridBagConstraints(1, 0, 2, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(67, 13, 0, 66), 163, -3));
        centerPanel.add(jLabel1, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(67, 23, 0, 0), 41, 3));
        centerPanel.add(jLabel2, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 23, 7, 0), 26, 2));
        centerPanel.add(GenericHandlerButton, new GridBagConstraints(1, 1, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(11, 13, 0, 122), -1, 0));
        centerPanel.add(OtherHandlerField, new GridBagConstraints(2, 2, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 157, 0), 210, 0));
        centerPanel.add(OtherHandlerButton, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 13, 157, 0), 0, 0));
        centerPanel.add(BrowseButton, new GridBagConstraints(3, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 6, 157, 36), 14, -5));
        ...
        if (groupName.equals("")) {
            ...
            try {
                ...
                for (int i = 0; i < groupNames[0].size(); i++) {
                    if (groupName.equals((String) groupNames[0].get(i))
                            && !groupName.equals(oldGroupName)) {
                        error = true;
