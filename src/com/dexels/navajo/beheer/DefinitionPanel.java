...
public class DefinitionPanel extends BaseNavajoPanel {
    ...
    void jbInit() throws Exception {
        ...
        centerPanel.add(typeField, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(18, 23, 175, 198), 0, 0));
        centerPanel.add(typeLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(20, 20, 175, 0), 8, 0));
        centerPanel.add(nameLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(68, 20, 0, 0), 0, 0));
        centerPanel.add(nameField, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(68, 23, 0, 69), 250, 0));
        ...
        if (def_name.equals("")) {
            ...
            try {
                ...
                for (int i = 0; i < definitionNames[0].size() && !error; i++) {
                    if (def_name.equals((String) definitionNames[0].get(i))
                            && !def_name.equals(oldDef_name)) {
                        error = true;
