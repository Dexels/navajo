...
public class ServiceGroupRowPanel extends BaseNavajoPanel {
    ...
    void jbInit() throws Exception {
        ...
        this.add(nameField, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 18, 3, 0), 355, 0));
        this.add(removeButton, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(1, 9, 3, 0), 0, -1));
    }
