...
public class ConditionPanel extends BaseNavajoPanel {
    ...
    void jbInit() throws Exception {
        ...
        centerPanel.add(commentField, new GridBagConstraints(0, 4, 2, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 24, 122, 34), 486, -4));
        centerPanel.add(jLabel2, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(66, 24, 0, 0), 0, 0));
        centerPanel.add(jLabel3, new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(7, 24, 0, 425), 40, 0));
        centerPanel.add(conditionField, new GridBagConstraints(0, 2, 2, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 24, 0, 34), 486, -4));
        centerPanel.add(jLabel4, new GridBagConstraints(0, 3, 2, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(12, 24, 0, 451), 12, 0));
        centerPanel.add(serviceBox, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(66, 7, 0, 222), 124, -4));
