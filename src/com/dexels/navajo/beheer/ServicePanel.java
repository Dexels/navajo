...
//    String bla = rootPanel.auth.getServlet(rootPanel.access, serviceName);
    ...
    centerPanel.add(jLabel26, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(69, 17, 0, 0), 6, 7));
    centerPanel.add(nameField, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 99), 145, 0));
    centerPanel.add(idField, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(69, 0, 0, 265), 57, 16));
    centerPanel.add(groupBox, new GridBagConstraints(1, 2, 1, 1, 1.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(14, 0, 148, 217), -20, 0));
    centerPanel.add(jLabel4, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(17, 17, 148, 21), 8, 0));
    centerPanel.add(jLabel2, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 17, 0, 6), 21, 0));
...
//      String servlet=(String)servletBox.getSelectedItem();
    ...
    try{
      ...
      for(int i =0; i<serviceNames[0].size()&&!error; i++){
        if(serviceName.equals((String)serviceNames[0].get(i))&&!serviceName.equals(oldServiceName)){
          error=true;
