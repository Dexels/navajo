...
public class LoginPanel extends BaseNavajoPanel {
    ...
    void jbInit() throws Exception {
        ...
        centerPanel.add(hostField, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(9, 19, 0, 108), 73, -4));
        centerPanel.add(databaseField, new GridBagConstraints(1, 2, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(9, 19, 0, 108), 51, -4));
        centerPanel.add(dbmsBox, new GridBagConstraints(1, 3, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(9, 19, 0, 108), 2, -4));
        centerPanel.add(hostLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(9, 74, 0, 0), 0, 0));
        centerPanel.add(dbmsLabel, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(9, 112, 0, 0), 0, 0));
        centerPanel.add(dbmsTypeLabel, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 83, 0, 0), 0, 0));
        centerPanel.add(dbUsernameField, new GridBagConstraints(1, 4, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(15, 18, 0, 108), 110, -4));
        centerPanel.add(dbPasswordField, new GridBagConstraints(1, 5, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(9, 17, 0, 108), 124, -4));
        centerPanel.add(dbmsUserLabel, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(15, 82, 0, 0), 0, 0));
        centerPanel.add(dbmsPwdLabel, new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(9, 53, 0, 0), 0, 0));
        centerPanel.add(loginButton, new GridBagConstraints(0, 6, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 20, 10, 108), 59, 0));
    ...
    void loginButton_actionPerformed(ActionEvent e) {
        ...
        if (keuze.equals("MSSQL")) {
            ...
            databaseLocation = "jdbc:inetdae7:" + host + ":1433?database="
                    + database;
