...
public class UserPanel extends BaseNavajoPanel {
    ...
    void jbInit() throws Exception {
        ...
        paramTab.add(parametersScrollPane, new GridBagConstraints(0, 1, 2, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 5, 0, 11), 349, 172));
        paramTab.add(addParamButton, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(6, 47, 11, 102), 0, 0));
        paramTab.add(paramValueLabel, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(6, 169, 0, 90), 0, 0));
        paramTab.add(paramNameLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(6, 47, 0, 0), 0, 0));
        jTabbedPane1.add(conditionTab, "Conditions");
        conditionTab.add(conditionsScrollPane, new GridBagConstraints(0, 1, 3, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 3, 0, 0), 472, 159));
        conditionTab.add(newConditionButton, new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 9, 33, 0), 34, -2));
        conditionTab.add(conditionLabel, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 93, 0, 0), 16, 1));
        conditionTab.add(conditionServiceLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 74, 0, 0), 29, 1));
    ...
    void okButton_actionPerformed(ActionEvent e) {
        ...
        if (userName.equals("")) {
            ...
            for (int i = 0; i < names.size() && !error; i++) {
                if (userName.equals((String) names.get(i))
