...
public class MessageTablePanel extends SplitPane {
	...
	public MessageTablePanel() {
		...
		Style ss = Styles.DEFAULT_STYLE_SHEET.getStyle(MessageTablePanel.class,
				"Default");
		myTable.setStyle(ss);
		...
		myTable.addTableEditorListener(new TableEditorListener() {
			...
			@Override
			public void propertyChanged(Property p, String eventType,
					int column, int row) {
		...
		pageNavigator.addPageIndexChangeListener(new PageIndexChangeListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 4653908904986712989L;
