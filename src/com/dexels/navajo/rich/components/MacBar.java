...
public class MacBar extends JPanel {
	...
	public void add(JComponent link) {
		if (orientation.equals(BAR_BOTTOM)) {
			this.add(link, new GridBagConstraints(getComponentCount(), 0, 1, 1, 0.0, 1.0, GridBagConstraints.SOUTH,
					GridBagConstraints.NONE, new Insets(0, 2, 0, 2), 0, 0));
		}
		if (orientation.equals(BAR_TOP)) {
			this.add(link, new GridBagConstraints(getComponentCount(), 0, 1, 1, 0.0, 1.0, GridBagConstraints.NORTH,
					GridBagConstraints.NONE, new Insets(0, 2, 0, 2), 0, 0));
		}
		if (orientation.equals(BAR_LEFT)) {
			this.add(link, new GridBagConstraints(0, getComponentCount(), 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
					new Insets(0, 2, 0, 2), 0, 0));
		}
		if (orientation.equals(BAR_RIGHT)) {
			this.add(link, new GridBagConstraints(0, getComponentCount(), 1, 1, 1.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
					new Insets(0, 2, 0, 2), 0, 0));
		}
	}
