...
//              paintChildren(g2);
                ...
                GradientPaint gp = new GradientPaint((float)(peel/2),(float)(peel/2),Color.darkGray, (float)peel, (float)peel, Color.white);
                g2.setPaint(gp);
                g2.fill(leaf);
                ...
                GradientPaint gpeel = new GradientPaint((float)(peel*0.75),(float)(peel*0.75),Color.lightGray, (float)peel, (float)peel, Color.white);
                g2.setPaint(gpeel);
                g2.fill(triaMax);
...
//              GradientPaint gppaper = new GradientPaint((float)(peel),(float)(peel),Color.lightGray, bounds.width, bounds.height, Color.white);
...
//                      g2.drawString("Mouse at " + mouseLoc.x + ", "+ mouseLoc.y + ", peel: " + peel, 100, 100);
//              }
                g2.dispose();
        }
