...
public class XmlMapperInterpreter {
  ...
  private String errorFieldNotFound(String field, Object o) {
    return   "Field (" + field + ") not found in mappable class (" + o.getClass().getName() + ")";
  }

  private String errorMethodNotFound(String method, Object o) {
    return   "Method (" + method + ") not found in mappable class(" + o.getClass().getName() + ")";
  }
  ...
  private String errorExpression(String msg, String expr) {
    return   "Expression evaluation error. Expr (" + expr + "), message (" + msg + ")";
  }
        ...
        throws org.xml.sax.SAXException, IOException
  {
    ...
    {
      Util.debugLog("error in XmlMapperInterpreter, xml script is not correct");
      Util.logMessage("error in XmlMapperInterpreter, xml script is not correct");
    }
...
//
  ...
  private static Object getAttributeObject(Object o, String name, Object [] arguments) throws com.dexels.navajo.server.UserException, MappingException
  {
    ...
    try {
      methodName = "get"+(name.charAt(0)+"").toUpperCase()+name.substring(1, name.length());
      ...
      for(int i=0; i<index; i++){
        ...
        if (tag.equals("break")) {
         ...
         if(tag.equals("map")){
          ...
          if (tag.equals("field") || tag.equals("property") || tag.equals("param")) {
