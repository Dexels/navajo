 ...
 * @generated
 */
public class NavajoExpressionSwitch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case NavajoExpressionPackage.TOP_LEVEL:
      {
      ...
      case NavajoExpressionPackage.EXPRESSION:
      {
