		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExpressionTagAccess().getAlternatives_3(), "rule__ExpressionTag__Alternatives_3");
					...
					put(grammarAccess.getMapEndAccess().getGroup(), "rule__MapEnd__Group__0");
					...
					put(grammarAccess.getExpressionTagAccess().getGroup_3_1(), "rule__ExpressionTag__Group_3_1__0");
					...
					put(grammarAccess.getMapAccess().getChildrenAssignment_1_1_1_3(), "rule__Map__ChildrenAssignment_1_1_1_3");
					put(grammarAccess.getMapAccess().getChildrenAssignment_1_1_1_4(), "rule__Map__ChildrenAssignment_1_1_1_4");
					put(grammarAccess.getMapAccess().getChildrenAssignment_1_1_1_5(), "rule__Map__ChildrenAssignment_1_1_1_5");
					put(grammarAccess.getMapAccess().getMapClosingNameAssignment_1_1_2(), "rule__Map__MapClosingNameAssignment_1_1_2");
					...
					put(grammarAccess.getParamAccess().getExpressionValueAssignment_3_1_1(), "rule__Param__ExpressionValueAssignment_3_1_1");
					...
					put(grammarAccess.getFieldAccess().getExpressionValueAssignment_4_1_0(), "rule__Field__ExpressionValueAssignment_4_1_0");
					...
					put(grammarAccess.getExpressionTagAccess().getAttributesAssignment_2(), "rule__ExpressionTag__AttributesAssignment_2");
					put(grammarAccess.getExpressionTagAccess().getExpressionAssignment_3_1_1(), "rule__ExpressionTag__ExpressionAssignment_3_1_1");
