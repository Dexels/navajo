...
public class KafenioPanelConfiguration implements KafenioPanelConfigurationInterface {
    ...
    private static String defaultToolbarTipiItems = "CLEARFORMATS,SEPARATOR,BOLD,ITALIC,UNDERLINE,SEPARATOR,LEFT,CENTER,RIGHT,JUSTIFY,SEPARATOR,STRIKE,SUPERSCRIPT,SUBSCRIPT,INSERTCHARACTER"
            + ",SEPARATOR,ULIST,OLIST,SEPARATOR,DEINDENT,INDENT,SEPARATOR,COLOR,TABLE,SEPARATOR,VIEWSOURCE";
