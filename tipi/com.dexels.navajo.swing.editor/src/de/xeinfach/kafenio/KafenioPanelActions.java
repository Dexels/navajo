...
public class KafenioPanelActions {
	...
	private FormatAction actionAddNewLine;
	...
	public KafenioPanelActions(KafenioPanel newParent) {
		...
		actionInsertCharacter = new SpecialCharAction(parent, getString("InsertCharacter") + KafenioMenuBar.DOTS);
		actionToggleCase = new ToggleCaseAction(parent, getString("ToggleCase") + KafenioMenuBar.DOTS);
		actionAddParagraph = new FormatAction(parent, getString("AddParagraph"), HTML.Tag.P, "left");
		actionAddNewLine = new FormatAction(parent, getString("NewLine"), HTML.Tag.BR);
		...
		actionBlockquote = new FormatAction(parent, getString("FormatBlockquote"), HTML.Tag.BLOCKQUOTE);
	...
	/**
	 * @return returns action to add a new line.
	 */
	public FormatAction getActionAddNewLine() {
		return actionAddNewLine;
	}
