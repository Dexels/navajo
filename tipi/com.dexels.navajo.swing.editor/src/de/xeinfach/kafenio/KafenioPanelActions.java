...
/**
 * Description: This class contains all shared actions of the editor. (currently
 * redoaction, undoaction and the JTextPane actions are still initialized in
 * KafenioPanel class, this will be changed later on.)
 * 
...
public class KafenioPanelActions {
	 ...
	 * 
	 * @param newParent
	 *            the KafenioPanel that these actions are for.
	 */
	public KafenioPanelActions(KafenioPanel newParent) {
		...
		actionFontStrike = new FormatAction(parent, getString("FontStrike"),
				HTML.Tag.STRIKE);
		actionFontSuperscript = new FormatAction(parent,
				getString("FontSuperscript"), HTML.Tag.SUP);
		actionFontSubscript = new FormatAction(parent,
				getString("FontSubscript"), HTML.Tag.SUB);
		actionListUnordered = new ListAutomationAction(parent,
				getString("ListUnordered"), HTML.Tag.UL);
		actionListOrdered = new ListAutomationAction(parent,
				getString("ListOrdered"), HTML.Tag.OL);

		Hashtable customAttr0 = new Hashtable();
		customAttr0.put("align", "left");
		actionAlignLeft = new CustomAction(parent, getString("AlignLeft"),
				HTML.Tag.P, customAttr0);

		Hashtable customAttr1 = new Hashtable();
		customAttr1.put("align", "center");
		actionAlignCenter = new CustomAction(parent, getString("AlignCenter"),
				HTML.Tag.P, customAttr1);

		Hashtable customAttr2 = new Hashtable();
		customAttr2.put("align", "right");
		actionAlignRight = new CustomAction(parent, getString("AlignRight"),
				HTML.Tag.P, customAttr2);

		Hashtable customAttr3 = new Hashtable();
		customAttr3.put("align", "justify");
		actionAlignJustified = new CustomAction(parent,
				getString("AlignJustified"), HTML.Tag.DIV, customAttr3);

		actionIndentLeft = new IndentAction(parent,
				KafenioToolBar.KEY_TOOL_INDENTLEFT);
		actionIndentRight = new IndentAction(parent,
				KafenioToolBar.KEY_TOOL_INDENTRIGHT);

		Hashtable customAttr = new Hashtable();
		customAttr.put("face", "");
		actionSelectFont = new CustomAction(parent, getString("FontSelect")
				+ KafenioMenuBar.DOTS, HTML.Tag.FONT, customAttr);

		actionClearFormat = new CustomAction(parent, getString("FormatClear"),
				new HTML.UnknownTag(""));
		actionInsertHyperlink = new CustomAction(parent,
				getString("InsertAnchor") + KafenioMenuBar.DOTS, HTML.Tag.A);
		actionInsertServerImage = new ServerImageAction(parent);
		actionInsertCharacter = new SpecialCharAction(parent,
				getString("InsertCharacter") + KafenioMenuBar.DOTS);
		actionToggleCase = new ToggleCaseAction(parent, getString("ToggleCase")
				+ KafenioMenuBar.DOTS);
		actionAddParagraph = new FormatAction(parent,
				getString("AddParagraph"), HTML.Tag.P, "left");

		actionHeading1 = new FormatAction(parent, getString("Heading1"),
				HTML.Tag.H1);
		actionHeading2 = new FormatAction(parent, getString("Heading2"),
				HTML.Tag.H2);
		actionHeading3 = new FormatAction(parent, getString("Heading3"),
				HTML.Tag.H3);
		actionHeading4 = new FormatAction(parent, getString("Heading4"),
				HTML.Tag.H4);
		actionHeading5 = new FormatAction(parent, getString("Heading5"),
				HTML.Tag.H5);
		actionHeading6 = new FormatAction(parent, getString("Heading6"),
				HTML.Tag.H6);

		actionAddListItem = new FormatAction(parent, getString("ListItem"),
				HTML.Tag.LI);

		actionBlockquote = new FormatAction(parent,
				getString("FormatBlockquote"), HTML.Tag.BLOCKQUOTE);
		actionPre = new FormatAction(parent, getString("FormatPre"),
				HTML.Tag.PRE);
		actionStrong = new FormatAction(parent, getString("FormatStrong"),
				HTML.Tag.STRONG);
		actionEmphasis = new FormatAction(parent, getString("FormatEmphasis"),
				HTML.Tag.EM);
		actionTT = new FormatAction(parent, getString("FormatTT"), HTML.Tag.TT);
		actionSpan = new FormatAction(parent, getString("FormatSpan"),
				HTML.Tag.SPAN);

		customAttr = new Hashtable();
		customAttr.put(FONTSIZE_KEY, "1");
		actionFontSize1 = new CustomAction(parent, getString("FontSize1"),
				HTML.Tag.FONT, customAttr);

		customAttr = new Hashtable();
		customAttr.put(FONTSIZE_KEY, "2");
		actionFontSize2 = new CustomAction(parent, getString("FontSize2"),
				HTML.Tag.FONT, customAttr);

		customAttr = new Hashtable();
		customAttr.put(FONTSIZE_KEY, "3");
		actionFontSize3 = new CustomAction(parent, getString("FontSize3"),
				HTML.Tag.FONT, customAttr);

		customAttr = new Hashtable();
		customAttr.put(FONTSIZE_KEY, "4");
		actionFontSize4 = new CustomAction(parent, getString("FontSize4"),
				HTML.Tag.FONT, customAttr);

		customAttr = new Hashtable();
		customAttr.put(FONTSIZE_KEY, "5");
		actionFontSize5 = new CustomAction(parent, getString("FontSize5"),
				HTML.Tag.FONT, customAttr);

		customAttr = new Hashtable();
		customAttr.put(FONTSIZE_KEY, "6");
		actionFontSize6 = new CustomAction(parent, getString("FontSize6"),
				HTML.Tag.FONT, customAttr);

		customAttr = new Hashtable();
		customAttr.put(FONTSIZE_KEY, "7");
		actionFontSize7 = new CustomAction(parent, getString("FontSize7"),
				HTML.Tag.FONT, customAttr);

		actionFormatBig = new FormatAction(parent, getString("FormatBig"),
				HTML.Tag.BIG);
		actionFormatSmall = new FormatAction(parent, getString("FormatSmall"),
				HTML.Tag.SMALL);

		customAttr = new Hashtable();
		customAttr.put("color", "black");
		actionFontCustomColor = new CustomAction(parent,
				getString("CustomColor") + KafenioMenuBar.DOTS, HTML.Tag.FONT,
				customAttr);
	...
	/**
	 * @return returns action that formats text-foreground in default color
	 *         (black)
	 */
