...
public final class Utils {
	...
	/**
	 * Ensures that the given string does not have a given character as the
	 * first one. If it is the case, all such characters are deleted from the
	...
	/**
	 * Ensures that the given string's last character is the given character. If
	 * the last character is the given character or an empty/null string is
	 * passed, the string is returned unchanged.
	 * 
	 * @param character
	 *            a character to check for
	 * @param aString
	...
	public static String ensureHasTrailing(char character, String aString) {
		if (aString != null && aString.length() > 0
				&& aString.charAt(aString.length() - 1) != character) {
	 ...
	 * @param inputString
	 *            input string to check
	 * @return returns the inputString or null if the inputString is empty or
	 *         null
	 */
