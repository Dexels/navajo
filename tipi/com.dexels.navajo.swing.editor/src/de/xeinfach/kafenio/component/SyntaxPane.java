 ...
 * 
 * <p>
 * <b>This class only works with java versions 1.4 and newer</b>
 * </p>
 * 
 * <p>
 ...
 * target
 * ="_blank">http://developer.java.sun.com/developer/technicalArticles/releases
 * /1.4regex/</a><br>
 * and<br>
 ...
 * </p>
 * 
 * @author Ulrich Hilger <a
 *         href="mailto:info@lightdev.com">info@lightdev.com</a>
...
public class SyntaxPane extends JTextPane implements CaretListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8877273306418064557L;
	 ...
	 * 
	 * @param doc
	 *            document to apply syntax highlighting to
	 * @param offset
	 *            position inside the given document to start to apply syntax
	 *            highlighting to
	 * @param len
	 *            number of characters to apply syntax highlighting to
	 */
	...
	/**
	 * internal class. StyleUpdater does the actual syntax highlighting work and
	 * can be used in SwingUtilities.invokeLater()
	 */
	private class StyleUpdater implements Runnable {
		 ...
		 * 
		 * @param spthe
		 *            SyntaxPane this StyleUpdater works on
		 * @param docthe
		 *            document to apply syntax highlighting to
		 * @param offsetthe
		 *            position inside the given document to start to apply
		 *            syntax highlighting to
		 * @param lenthe
		 *            number of characters to apply syntax highlighting to
		 */
		public StyleUpdater(SyntaxPane panel, StyledDocument newDoc,
				int newOffset, int newLen) {
			this.doc = newDoc;
