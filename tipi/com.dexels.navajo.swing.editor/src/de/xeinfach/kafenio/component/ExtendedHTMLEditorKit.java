...
/**
 * Description: This class extends HTMLEditorKit so that it can provide other
 * renderer classes instead of the defaults. Most important is the part which
 * renders relative image paths.
 * 
...
public class ExtendedHTMLEditorKit extends HTMLEditorKit {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3117497752605892737L;
	private static LeanLogger log = new LeanLogger(
			"ExtendedHTMLEditorKit.class");
	 ...
	 * 
	 * @param baseUrl
	 *            creates the default document and sets the base url of the
	 *            html-document to the given value. if base url is null, no base
	 *            url will be set.
	 * @return returns a Document
	 */
