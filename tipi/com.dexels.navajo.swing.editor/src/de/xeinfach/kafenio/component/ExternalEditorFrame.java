...
/**
 * Description: This class is an extended JFrame that overrides the
 * processWindowEvent() method. If the WindowEvent WINDOW_CLOSING is caught, the
 * parentApplet's popEditorIn() method is called.
 * 
...
public class ExternalEditorFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2038071202067068641L;
	 ...
	 *            the window title
	 * @param parent
	 *            the KafenioContainerInterface that instanciates this class.
	 */
	public ExternalEditorFrame(String frameTitle,
			KafenioContainerInterface parent) {
		super();
