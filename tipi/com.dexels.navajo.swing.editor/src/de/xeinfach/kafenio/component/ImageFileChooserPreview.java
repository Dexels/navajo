 ...
 */
public class ImageFileChooserPreview extends JComponent implements
		PropertyChangeListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2972327176174609949L;

	private static LeanLogger log = new LeanLogger(
			"ImageFileChooserPreview.class");
	 ...
	 * 
	 * @param parent
	 *            a JFileChooser that this preview window is used in.
	 */
	...
	public void loadImage() {
		...
		if (imageThumb.getIconHeight() < PREVIEW_HEIGHT
				&& imageThumb.getIconWidth() < PREVIEW_WIDTH) {
			return;
		}
	 ...
	 * 
	 * @param g
	 *            a Graphics object to use when painting the component.
	 */
