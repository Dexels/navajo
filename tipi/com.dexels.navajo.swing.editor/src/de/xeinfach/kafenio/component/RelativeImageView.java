...
/**
  ...
  *
  * This code was modeled after an article on
...
public class RelativeImageView extends View implements ImageObserver, MouseListener, MouseMotionListener {
	 ...
	 * @returns a URL for the image source or null if it could not be determined.
	 */
	 ...
	 * @param iDefault default int value
	 * @return returns int value of the given attribute or the default if the given attribute was not found.
	 */
	 ...
	 * @param delay delay before repainting.
	 */
	...
	/**
	 * updates the image.
	 * @param img the image to update to
