...
public abstract class AbstractKafenioDialog extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2742090084668719309L;

	private static LeanLogger log = new LeanLogger(
			"AbstractKafenioDialog.class");
	 ...
	 * 
	 * @param panelContents
	 *            contents of the Dialop JOptionPane
	 */
	 ...
	 * 
	 * @param panelContents
	 *            contents of the Dialog JOptionPane
	 * @param newButtonLabels
	 *            button labels
	 * @param newOptionType
	 *            option types
	 * @param newType
	 *            panel type
	 */
	public void init(Object[] panelContents, String[] newButtonLabels,
			Integer newOptionType, Integer newType) {
		...
		jOptionPane = new JOptionPane(panelContents, type, optionType, null,
		...
		getJOptionPane().addPropertyChangeListener(
	...
	/**
	 * @param pane
	 *            sets the JOptionPane used in this dialog.
	 */
	 ...
	 * 
	 * @param newButtonLabels
	 *            Object[] containing button labels as strings.
