 ...
 */
public class FontSelectorDialog extends AbstractKafenioDialog implements
		ItemListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1511519700302592811L;
	 ...
	 *            an attribute name
	 * @param demoText
	 *            demo text to insert as default when new dialog window is
	 *            shown.
	 */
	public FontSelectorDialog(KafenioPanel parent, String title,
			boolean bModal, String attribName, String demoText) {
		...
		final HTMLDocument docFontPreview = (HTMLDocument) (kitFontPreview
		...
		panelContents = new Object[] { attribName, jcmbFontlist,
				parent.getTranslation("FontSample"), jtpFontPreview };
		init(panelContents);
	}
	 ...
	 * 
	 * @param value
	 *            default values to be used in this method.
	 */
	 ...
	 */
	public FontSelectorDialog(KafenioPanel parent, String title,
			boolean bModal, String attribName) {
