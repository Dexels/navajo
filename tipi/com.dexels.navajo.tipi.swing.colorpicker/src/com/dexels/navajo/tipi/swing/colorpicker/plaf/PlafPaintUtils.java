 ...
 * @(#)PlafPaintUtils.java
 *
 * $Date: 2015-09-03 14:46:57 -0400 (Thu, 03 Sep 2015) $
 *
...
import com.dexels.navajo.tipi.swing.colorpicker.util.JVM;
...
public class PlafPaintUtils {
    ...
    final static Color[] whites = new Color[] { new Color(255, 255, 255, 50), new Color(255, 255, 255, 100), new Color(255, 255, 255, 150) };
    ...
    /**
     * @return the color used to indicate when a component has focus. By default this uses the color (64,113,167), but you can override this by calling: <BR>
    ...
    public static void paintFocus(Graphics2D g, Shape shape, int pixelSize, Color focusColor, boolean changeRenderingHints) {
        ...
        try {
            Color[] focusArray = new Color[] { new Color(focusColor.getRed(), focusColor.getGreen(), focusColor.getBlue(), 235 * focusColor.getAlpha() / 255),
    ...
    public static Color tween(Color c1, Color c2, float p) {
        ...
        return new Color((int) (r1 * (1 - p) + r2 * p), (int) (g1 * (1 - p) + g2 * p), (int) (b1 * (1 - p) + b2 * p), (int) (a1 * (1 - p) + a2 * p));
    }
