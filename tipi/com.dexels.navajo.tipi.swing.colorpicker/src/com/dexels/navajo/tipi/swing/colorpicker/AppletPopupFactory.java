 ...
 * <p>
 * Many browsers consistently render popups in the wrong location: they take the (x, y) of the applet but display the popup menu relative to the browser window
 * instead of the applet -- so it is displaced up and to the left.
 * <p>
 * This was specifically designed with JPopupMenus and tooltips in mind.
 *
 */
