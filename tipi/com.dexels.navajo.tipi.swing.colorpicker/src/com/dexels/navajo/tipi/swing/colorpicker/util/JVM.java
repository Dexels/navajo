 ...
 * @(#)JVM.java
 *
 * $Date: 2015-06-04 03:15:46 -0400 (Thu, 04 Jun 2015) $
 *
 ...
 * <P>
 * Instead of burying a constant like "isQuartz" in its most relevant class (such as OptimizedGraphics2D), it should be stored here so if other classes need to
 * access it they don't necessary have to
 */
public class JVM {
    ...
    /**
     * If on a Mac: whether Quartz is the rendering pipeline. In applets this may throw a security exception; if this cannot be ascertained we assume it is
     * false.
     */
    ...
    private static boolean isUsingQuartz() {
        try {
            return isMac && ((javaVersion > 0 && javaVersion < 1.4f) || (System.getProperty("apple.awt.graphics.UseQuartz") != null
                    && System.getProperty("apple.awt.graphics.UseQuartz").toString().equals("true")));
        } catch (AccessControlException e) {
            e.printStackTrace();
            return false;
        }
    ...
    /**
     * This converts the system property "java.version" to a float value. This drops rightmost digits until a legitimate float can be parsed. <BR>
