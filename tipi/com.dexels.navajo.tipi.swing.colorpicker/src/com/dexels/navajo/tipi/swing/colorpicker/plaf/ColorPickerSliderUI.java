...
import com.dexels.navajo.tipi.swing.colorpicker.ColorPickerPanel;
...
public class ColorPickerSliderUI extends BasicSliderUI {
    ...
    /**
     * This overrides the default behavior for this slider and sets the thumb to where the user clicked. From a design standpoint, users probably don't want to
     * scroll through several colors to get where they clicked: they simply want the color they selected.
     */
