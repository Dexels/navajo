...
public class TablePropertiesDialog extends OptionDialog
{
    ...
    private String title = i18n.str("table_properties"); //$NON-NLS-1$
    private String desc = i18n.str("table_properties_desc"); //$NON-NLS-1$
    ...
    {
        super(parent,i18n.str("table_properties"), i18n.str("table_properties_desc"), icon);
        init();       
    }
