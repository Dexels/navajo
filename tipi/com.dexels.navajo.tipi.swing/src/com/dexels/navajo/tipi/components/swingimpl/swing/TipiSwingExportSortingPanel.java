...
public class TipiSwingExportSortingPanel extends JPanel {
	...
	JList<String> availableColumnsList = new JList<String>();
	JList<String> exportedColumnsList = new JList<String>();
	...
	private final void fillAvailableList(Message m) {
		...
		for (int i = 0; i < props.size(); i++) {
			...
			DefaultListModel<String> am =  (DefaultListModel<String>) availableColumnsList
					.getModel();
	...
	private final void jbInit() throws Exception {
		availableColumnsList.setModel(new DefaultListModel<String>());
		exportedColumnsList.setModel(new DefaultListModel<String>());
		...
		removeButton
				.addActionListener(new TipiExportSortingPanel_removeButton_actionAdapter(
						this));
		...
		removeButton
				.setIcon(getIcon("com/dexels/navajo/tipi/components/swingimpl/swing/arrow_left.gif"));
		this.add(availableColumnsLabel, new GridBagConstraints(0, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(2, 2, 0, 0), 128, 0));
		this.add(exportedColumnsLabel, new GridBagConstraints(2, 0, 1, 1, 0.0,
				0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(2, 2, 0, 0), 114, 0));
	...
	void addButton_actionPerformed(ActionEvent e) {
		List<String> items = availableColumnsList.getSelectedValuesList();
		DefaultListModel<String> em = (DefaultListModel<String>) exportedColumnsList.getModel();
		DefaultListModel<String> am = (DefaultListModel<String>) availableColumnsList
				.getModel();

		for (String element : items) {
			em.removeElement(element);
			am.addElement(element);
		}
	}

	void removeButton_actionPerformed(ActionEvent e) {
		List<String> items = exportedColumnsList.getSelectedValuesList();
		DefaultListModel<String> em = (DefaultListModel<String>) exportedColumnsList.getModel();
		DefaultListModel<String> am = (DefaultListModel<String>) availableColumnsList
				.getModel();
		for (String element : items) {
	...
	void sortUpButton_actionPerformed(ActionEvent e) {
		...
		DefaultListModel<String> vm = (DefaultListModel<String>) exportedColumnsList.getModel();
		if (index > 0) {
			String value = exportedColumnsList.getSelectedValue();
	...
	public List<String> getExportedPropertyNames() {
		...
		for (int i = 0; i < exportedColumnsList.getModel().getSize(); i++) {
			String current = exportedColumnsList.getModel()
					.getElementAt(i);
...
class TipiExportSortingPanel_addButton_actionAdapter implements
		java.awt.event.ActionListener {
	TipiSwingExportSortingPanel adaptee;

	TipiExportSortingPanel_addButton_actionAdapter(
			TipiSwingExportSortingPanel adaptee) {
...
class TipiExportSortingPanel_removeButton_actionAdapter implements
		java.awt.event.ActionListener {
	TipiSwingExportSortingPanel adaptee;

	TipiExportSortingPanel_removeButton_actionAdapter(
			TipiSwingExportSortingPanel adaptee) {
		this.adaptee = adaptee;
	}
...
class TipiExportSortingPanel_sortUpButton_actionAdapter implements
		java.awt.event.ActionListener {
	TipiSwingExportSortingPanel adaptee;

	TipiExportSortingPanel_sortUpButton_actionAdapter(
			TipiSwingExportSortingPanel adaptee) {
		this.adaptee = adaptee;
	}
...
class TipiExportSortingPanel_sortDownButton_actionAdapter implements
		java.awt.event.ActionListener {
	TipiSwingExportSortingPanel adaptee;

	TipiExportSortingPanel_sortDownButton_actionAdapter(
			TipiSwingExportSortingPanel adaptee) {
		this.adaptee = adaptee;
	}
