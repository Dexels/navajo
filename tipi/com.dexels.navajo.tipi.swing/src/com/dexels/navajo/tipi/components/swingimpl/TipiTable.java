        ...
        mm.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    getAttributeProperty("selectedMessage").setAnyValue(selectedMessage);
        ...
        if (name != null) {
            ...
            if (name.equals("selectedMessages")) {
                ...
                if (all != null) {
                    ...
                    Message resultMsg;
                    if (all.size() > 0) {
                        resultMsg = NavajoFactory.getInstance().createMessage(n, all.get(0).getName(), Message.MSG_TYPE_ARRAY);
                ...
                if ("editCell".equals(name)) {
                    ...
                    if (value == null) {
                        logger.warn("Error: can not editCell, property null. Expression: "
                                + compMeth.getParameter("property").toString());
                    } else {
                        editCell(value);
                    }
                }
