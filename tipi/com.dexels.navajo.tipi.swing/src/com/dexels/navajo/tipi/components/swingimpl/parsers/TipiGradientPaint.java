...
public class TipiGradientPaint extends GradientPaint {
	...
	public GradientPaint getPaint() {
		...
		if (NORTHEAST.equals(direction)) {
			gp = new GradientPaint(0, bounds.height, colorOne, bounds.width, 0,
					colorTwo);
			return gp;
		}
		if (NORTHWEST.equals(direction)) {
			gp = new GradientPaint(bounds.width, bounds.height, colorOne, 0, 0,
					colorTwo);
			return gp;
		}
		if (SOUTHEAST.equals(direction)) {
			gp = new GradientPaint(0, 0, colorOne, bounds.width, bounds.height,
					colorTwo);
			return gp;
		}
		if (SOUTHWEST.equals(direction)) {
			gp = new GradientPaint(bounds.width, 0, colorOne, 0, bounds.height,
					colorTwo);
			return gp;
		}
		return gp;
