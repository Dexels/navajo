 ...
 * 
 */
public class ToItalic extends FunctionInterface {
	...
	public String remarks() {
        return "Make text italic. Html-style (depending on 2nd parameter including html tag)";
    }
    ...
    @Override
	public String usage() {
        return "ToItalic(string, boolean|empty)";
    }
