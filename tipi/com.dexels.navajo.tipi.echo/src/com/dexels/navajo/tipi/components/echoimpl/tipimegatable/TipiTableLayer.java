...
//        readOnly = elt.getBooleanAttribute("readOnly", "true", "false", false);
    ...
    // }
    //
    // public void addConditionalRemark(String remark, String condition, String
    // c, String font) {
    // ConditionalRemark cr = new ConditionalRemark(myTable, remark, condition,
    // -1, c, font);
...
//        }
        ...
        // for (Iterator iter = aggregateMap.keySet().iterator();
        // iter.hasNext(); ) {
        // Integer item = (Integer) iter.next();
        // myFooterRenderer.addAggregate(item.intValue(), (String)
    ...
    // newElt.setAttribute("columnsButtonVisible", columnsButtonVisible ? "true"
    // : "false");
    ...
    // }
    // String aggr = (String) aggregateMap.get(Integer.valueOf(i));
    // if (aggr != null) {
    ...
    // ConditionalRemark current = (ConditionalRemark)
    // conditionalRemarks.get(i);
    ...
    // private RemarkPanel createRemarkPanel(JComponent parentPanel, Message
    // currentMessage, MessageTablePanel mtp) {
    // RemarkPanel remarkPanel = new RemarkPanel(myTable, mtp, currentMessage,
    // this, conditionalRemarks);
