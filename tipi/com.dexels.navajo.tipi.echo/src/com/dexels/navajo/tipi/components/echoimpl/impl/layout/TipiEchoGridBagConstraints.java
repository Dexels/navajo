...
public class TipiEchoGridBagConstraints extends GridLayoutData {
	...
	public TipiEchoGridBagConstraints(int x, int y, int w, int h, double wx,
...
//			Insets insets = new Insets(Integer.parseInt(myConstraints[8]),
...
//			int ipady = Integer.parseInt(myConstraints[13]);
	...
	public String toString() {
		return "x:" + gridx + "y:" + gridy + "w:" + getColumnSpan() + "h:"
				+ getRowSpan();
	}

	public TipiEchoGridBagConstraints(String s, Component parent,
