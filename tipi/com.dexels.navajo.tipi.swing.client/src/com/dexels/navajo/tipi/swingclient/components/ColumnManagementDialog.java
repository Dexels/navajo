...
public class ColumnManagementDialog extends JDialog {
    ...
    private final static Logger logger = LoggerFactory.getLogger(ColumnManagementDialog.class);
    ...
    private final void jbInit() throws Exception {
        ...
        this.getContentPane().add(scroll1, new GridBagConstraints(0, 1, 1, 2, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(2, 2, 2, 2), 130, 204));
        this.getContentPane().add(hideButton, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.NORTH,
                GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 26, 0));
        this.getContentPane().add(showButton, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTH,
                GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 26, 0));
        this.getContentPane().add(scroll2, new GridBagConstraints(2, 1, 2, 2, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(2, 2, 2, 2), 133, 206));
        scroll2.getViewport().add(visibleColumnList);
        this.getContentPane().add(jLabel1, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(2, 2, 2, 2), 10, 0));
        this.getContentPane().add(jLabel2, new GridBagConstraints(2, 0, 2, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(2, 2, 2, 2), 32, 0));
        this.getContentPane().add(okButton, new GridBagConstraints(3, 3, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
        this.getContentPane().add(cancelButton, new GridBagConstraints(4, 3, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
                GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        this.getContentPane().add(upButton, new GridBagConstraints(4, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
        this.getContentPane().add(downButton, new GridBagConstraints(4, 2, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    }
...
class ColumnManagementDialog_hideButton_actionAdapter implements java.awt.event.ActionListener {
...
class ColumnManagementDialog_showButton_actionAdapter implements java.awt.event.ActionListener {
    ColumnManagementDialog adaptee;
...
class ColumnManagementDialog_okButton_actionAdapter implements java.awt.event.ActionListener {
    ColumnManagementDialog adaptee;
...
class ColumnManagementDialog_cancelButton_actionAdapter implements java.awt.event.ActionListener {
    ColumnManagementDialog adaptee;
...
class ColumnManagementDialog_upButton_actionAdapter implements java.awt.event.ActionListener {
    ColumnManagementDialog adaptee;
...
class ColumnManagementDialog_downButton_actionAdapter implements java.awt.event.ActionListener {
    ColumnManagementDialog adaptee;
