...
public class StandardWindow extends BaseWindow implements DialogConstants {
	...
	public void reloadWindow() {
		System.err
				.println("WARNING: You called reloadWindow in StandardWindow, this should be overridden");
	}
	...
	private final void jbInit() throws Exception {
		...
		im.put(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, 0, false),
				"DownPressed");
		im.put(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, 0, false),
				"LeftPressed");
		...
		im.put(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, 0, true),
				"DownReleased");
		im.put(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, 0, true),
				"LeftReleased");
		im.put(KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT, 0, true),
				"RightReleased");
		im.put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0, true),
				"EnterReleased");
	...
	void closeButton_actionPerformed(ActionEvent e) {
		try {
			closeWindow(); // hier stond: super.closeWindow() daardoor was ie
							// niet te overiden
	...
	// SwingClient.getUserInterface().updateMenu(getWindowId(),
	// getLocalWindowState());
	// }
	//
