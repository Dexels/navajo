...
/**
 * The conversion class that is an image consumer and creates a buffered image
 * as the output.
 * <p>
 * 
 * The generator only works on a single image instance at a time. The consumer
 * can be reset if needed to work on another image.
 * 
 * @author Justin Couch
 * @version $Revision$
 * 
...
public class ImageGenerator implements ImageConsumer {
	...
	/**
	 * Set the color model to use for the new image based on the model used by
	 * the source image.
	 * 
	 * @param model
	 *            The model to use
	...
	/**
	 * Notification of a bunch of pixel values in byte form. Used for 256 color
	 * or less images (eg GIF, greyscale etc).
	 * 
	 * @param x
	 *            The starting x position of the pixels
	 * @param y
	 *            The starting y position of the pixels
	 * @param w
	 *            The number of pixels in the width
	 * @param h
	 *            The number of pixels in the height
	 * @param model
	 *            The color model used with these pixel values
	 * @param offset
	 *            The offset into the source array to copy from
	 * @param scansize
	...
	/**
	 * Notification of a bunch of pixel values as ints. These will be full 3 or
	 * 4 component images.
	 * 
	 * @param x
	 *            The starting x position of the pixels
	...
	/**
	 * Convenience method used to create the output image based on the data that
	 * has been given to us so far. Will not create the image until all the
	 * necessary information is given, and once created, will not overwrite the
	 * current image.
	 * 
	 * Torsten Use another constructor of BufferedImage. With the one used here
	 * the resulting jpg was extremely blueish.
	 */
