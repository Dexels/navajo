 ...
 *
 */
public class CamelAdapterLibrary implements ExtensionDefinition {
	...
	public InputStream getDefinitionAsStream() {
		return getClass().getClassLoader().getResourceAsStream("com/dexels/navajo/camel/adapter/adapters.xml");
	}
	...
	public String getDescription() {
		return "The Camel Adapter Library";
	}
