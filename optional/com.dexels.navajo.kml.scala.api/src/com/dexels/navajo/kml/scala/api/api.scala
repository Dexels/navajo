...
trait KmlComponent extends com.dexels.navajo.scala.BaseAdapters with com.dexels.navajo.scala.Base { self: com.dexels.navajo.scala.ScalaScript => 
...
class KML(instance: com.dexels.navajo.geo.KMLMap = new com.dexels.navajo.geo.KMLMap) extends Adapter(instance) {
  def instance(f: com.dexels.navajo.geo.KMLMap => Unit): Unit = {
    f(instance)
  }
}