...
public class SQLFieldDependencyTest extends TestCase {
	...
	public void testQuery1() {
		...
		SQLFieldDependency s = new SQLFieldDependency(-1, "SQLMap", "sql", example);
...
"ELSE vmc.key " +
		...
		assertEquals("organizationpersonhistory", s.getMultipleDependencies()[4].getId());
	...
	public void testQuery3() {
		...
		assertEquals("table", ((AdapterFieldDependency) s.getMultipleDependencies()[0]).getType());
