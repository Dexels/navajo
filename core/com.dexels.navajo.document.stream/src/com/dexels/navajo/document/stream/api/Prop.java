...
public class Prop {
	...
	public static Prop create(String name, Object value, String type,List<Select> selections, Prop.Direction direction, String description, int length, String subtype ) {
		return new Prop(name,value,type,selections,direction,description,length,subtype);
	}
