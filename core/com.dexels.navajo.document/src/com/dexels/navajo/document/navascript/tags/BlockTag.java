...
public class BlockTag extends BaseNode implements NS3Compatible {
	...
	public BlockTag(Navajo n) {
		super(n);
		System.err.println("Created BlockTag: " + hashCode());
	}

	public void add(NS3Compatible node) {
		System.err.println("In BlockTag" + this.hashCode() + ". Adding: " + node);
	...
	public List<? extends BaseNode> getChildren() {
		System.err.println("In BlockTag " + this.hashCode() + ".getChildren(): " + myChildren.size());
		return myChildren;
	}
