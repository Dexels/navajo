...
public class BaseMessageImpl extends BaseNode implements Message, Comparable<Message> {
    ...
    private final static Logger logger = LoggerFactory.getLogger(BaseMessageImpl.class);
    ...
    /**
     * Add a collection of properties to a message. Properties that already
    ...
    /**
     * Merges messsage with another message. Properties and submessages are
     * merged. Properties of other message have precedence.
     * 
     * @param origMsg
     * @param mergeThisMsg
     */
    ...
    public final boolean isEqual(Message o, String skipProperties) {
        ...
        List<Property> allOtherProps = other.getAllProperties();
        List<Property> allMyProps = this.getAllProperties();
                    ...
                    if (!"".equals(order)) {
                        ...
                        while (it.hasNext() && compare == 0) {
                            ...
                            if (oV.indexOf("(") != -1) {
                                ...
                                Comparator c = null;
                                try {
                                    // Class<? extends Comparator> compareClass
                                    // = null;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Property prop2 = NavajoFactory.getInstance().createProperty(testDoc, "stringprop",
                    Property.STRING_PROPERTY, "navajo", 10, "", Property.DIR_OUT);
            msg.addProperty(prop2);

            Property prop3 = NavajoFactory.getInstance().createProperty(testDoc, "integerprop",
                    Property.INTEGER_PROPERTY, "2", 10, "", Property.DIR_OUT);
            msg.addProperty(prop3);

            Property prop4 = NavajoFactory.getInstance().createProperty(testDoc, "propfloat", Property.FLOAT_PROPERTY,
                    "5.0", 10, "", Property.DIR_OUT);
            ...
            // prop6.addSelection(NavajoFactory.getInstance().createSelection(testDoc,
            // "aap", "aap", false));
            // prop6.addSelection(NavajoFactory.getInstance().createSelection(testDoc,
            // "noot", "noot", false));
            ...
            Property prop7 = NavajoFactory.getInstance().createProperty(testDoc, "propbinary",
                    Property.BINARY_PROPERTY, "", 10, "", Property.DIR_OUT);
            prop7.setAnyValue(b);
            ...
            Property prop5 = NavajoFactory.getInstance().createProperty(testDoc, "proppie", Property.STRING_PROPERTY,
                    "", 0, "", Property.DIR_INOUT);
