...
public interface Property extends java.io.Serializable, Comparable<Property>, Cloneable {
    ...
    public static final String[] VALID_DATA_TYPES = new String[] { STRING_PROPERTY,
            INTEGER_PROPERTY, LONG_PROPERTY, DATE_PROPERTY, FLOAT_PROPERTY, MONEY_PROPERTY,
            CLOCKTIME_PROPERTY, COORDINATE_PROPERTY, URL_PROPERTY, MEMO_PROPERTY, BOOLEAN_PROPERTY,
            POINTS_PROPERTY, DATE_PATTERN_PROPERTY, PASSWORD_PROPERTY, TIPI_PROPERTY,
            BINARY_PROPERTY, EXPRESSION_PROPERTY, PERCENTAGE_PROPERTY, STOPWATCHTIME_PROPERTY,
            LIST_PROPERTY };

    // maybe DATE_PATTERN_PROPERTY?
    public static final String[] STRING_DATA_TYPES = new String[] { STRING_PROPERTY, MEMO_PROPERTY,
            PASSWORD_PROPERTY };
    ...
    public static final String[] VALID_DIRECTIONS = new String[] { DIR_IN, DIR_OUT, DIR_INOUT };

    public static final String CARDINALITY_SINGLE = "1";
    public static final String CARDINALITY_MULTIPLE = "+";

    public static final String[] VALID_CARDINALITIES = new String[] { CARDINALITY_SINGLE,
    ...
    /**
     * Get a selection option with a specific name if it exists. If it does not exists, return
     * null. If the property is not of type "selection", a NavajoException is thrown.
     */
    public Selection getSelection(String name);

    /**
     * Get a selection option with a specific value if it exists. If it does not exists, return
     * null. If the property is not of type "selection", a NavajoException is thrown.
     */
    public Selection getSelectionByValue(String value);

    /**
     * Return all selection objects in the property. If the property object is not of a selection
     * type, a NavajoException is thrown.
     */
    ...
    /**
     * Add a selection option to a "selection" property. If the option name already exists, we DO
     * NOT replace it with the new one. If the property is not a "selection" type, a
     * NavajoException is thrown.
     *
     * @param s Selection
     * @throws NavajoException
     */
     ...
     * Example: key="true,auto,optional", if key has true as value the underlying property is
     * marked as a 'key'. The auto option defines that a property is automatically created by an
     * insert operation, i.e. it should not be passed when inserting a new entity.
     *
     * @param key
     */
    ...
    /**
     * Set the method attribute to indicate whether this property is relevant for request,
     * response, or both
     *
    ...
    /**
     * Sets the reference attribute for a property. Reference can be used to indicate that this
     * property value can be used to find a specific entity that is specified by the reference
     * value.
     *
     * @param ref
     * @return
    ...
    /**
     * Gets all subtypes in a map This map is a copy, so there is no point in modifying.
     *
     * @return
     */
    ...
    /**
     * Also gets the type of a property (see PROPERTY_* constants). However, this type is based on
     * the type returned by the expression. Will throw a NavajoException when this is not of type
     * EXPRESSION
     *
    ...
    /**
     * Get the value of a (string, integer, float, boolean, date, clocktime, money, coordinate or
     * memo) property.
     *
    ...
    /**
     * Get the typed value (String, Integer, Double, Boolean, Date, Money, ClockTime, Coordinate
     * byte [])
     *
     * @return Object value
     */
    ...
    /**
     * Does the same as setValue(String) however, it will return the value that was actually set.
     * This can be different than the original paramenter, because the typechecker may have changed
     * the case, truncated, or changed it somehow.
     *
     * @param String value
    ...
    /**
     * Set the value of a (string, integer, float, boolean, date or memo) property. Try to use the
     * setCheckedValue, if you need to know what the value is that was actually set.
     */
    ...
    /**
     * Sets multiple selections for a selection type Property with a Cardinality '+' The list
     * should list the property VALUES!
     *
     * @throws NavajoException
     */
    ...
    /**
     * Sets multiple selections for a selection type Property with a Cardinality '+'
     *
     * @throws NavajoException
     */
    ...
    /**
     * Returns the length attribute of a (string, integer or float) property. The length defines
     * the maximum number of posititions a property value may have.
     */
    public int getLength();

    /**
     * Sets the length attribute of a (string, integer or float) property.
     */
    ...
    /**
     * Returns the description of a general property. This attribute is not required, hence it
     * could not be present.
     */
    public String getDescription();

    /**
     * Returns the direction of a general property. The direction defines whether the property is
     * input (in), output (out) or both (inout).
     */
    public String getDirection();

    /**
     * Sets the direction of a general property.
     */
    public void setDirection(String dir);

    /**
     * Returns the cardinality of a "selection" property. The cardinality defines the maximum
     * number of options that can be selected from a "selection" property. Currently to values are
     * supported: "+", for multiple selections and "1", for single selections.
     */
    public String getCardinality();

    /**
     * Sets the cardinality of a "selection" property. If the property is not of type "selection"
     * the attribute is set anyway, however it is ignored.
     */
    public void setCardinality(String cardinality);

    /**
     * Returns the message object in which this property is located.
     */
    public Message getParentMessage();

    /**
     * Returns the internal implementation specific representation of the Property.
     */
    ...
    /**
     * Returns the Navajo doc this object is part of.
     */
    public Navajo getRootDoc();

    /**
     * Replaces the Navajo doc this object is part of with this one.
     */
    public void setRootDoc(Navajo n);

    /**
     * Returns the selected selection. Will return a dummyselection when none is selected, and will
     * throw a NavajoException if more than one is Selected.
     */
    public Selection getSelected();

    /**
     * Returns a cloned Property belonging to the same parent document.
     */
    public Object clone();

    /**
     * Returns a cloned Property belonging to the same parent document, but giving it a new name.
     */
    public Object clone(final String newName);

    /**
     * Looks for the appropriate setter for this object, and sets it. From now on, I think this is
     * the safest accessor, if you are unsure about the type (for example, the result from an
     * operand) what type you are dealing with. Nano and jaxp are identical.
     */
     ...
     * operand) what type you are dealing with. Nano and jaxp are identical.
     *
     * @param internal when set, no "onValueChanged" event will be fired for Tipi.
     */
    public void setAnyValue(Object value, Boolean internal);
    ...
    public boolean printStartTag(final Writer sw, int indent, boolean forceDualTags)
            throws IOException;
