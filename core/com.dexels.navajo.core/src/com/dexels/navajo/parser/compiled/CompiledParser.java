...
public class CompiledParser/*@bgen(jjtree)*/implements CompiledParserTreeConstants, CompiledParserConstants {/*@bgen(jjtree)*/
  ...
  final public void PossiblePipe() throws ParseException {
    if (jj_2_3(2)) {
      OrExpression();
    } else if (jj_2_4(2)) {
      ...
      jj_consume_token(PIPE);
                    ASTReactivePipeSegment jjtn002 = new ASTReactivePipeSegment(JJTREACTIVEPIPESEGMENT);
  ...
  final public ASTPipeline ReactivePipe() throws ParseException {
 /*@bgen(jjtree) Pipeline */
  ASTPipeline jjtn000 = new ASTPipeline(JJTPIPELINE);
