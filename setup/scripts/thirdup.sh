...
mvn deploy:deploy-file -DrepositoryId=dexels -Durl=http://repo.dexels.com/repository/thirdparty -DgroupId=$groupId -DartifactId=$artifactId -Dversion=$version -Dfile=$1 -Dpackaging=jar
