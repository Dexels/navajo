...
public class InMessageTransformerFactory implements ReactiveTransformerFactory {

	public InMessageTransformerFactory() {
	...
	public ReactiveTransformer build(String relativePath, Optional<XMLElement> xml,
		...
		return new InMessageTransformer(parameters);
	}
