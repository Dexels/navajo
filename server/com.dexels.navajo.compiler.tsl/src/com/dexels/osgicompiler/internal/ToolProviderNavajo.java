 ...
 * @since 1.6
 */
public class ToolProviderNavajo {
    ...
    static <T> T trace(Level level, Object reason) {
        ...
        try {
            if (System.getProperty(propertyName) != null) {
                ...
                String method = "???";
                String cls = ToolProviderNavajo.class.getName();
                if (st.length > 2) {
            ...
            System.err.format((Locale)null, "%s: %s; %s%n",
                              ToolProviderNavajo.class.getName(),
                              reason,
    ...
    private static ToolProviderNavajo instance;

    private static synchronized ToolProviderNavajo instance() {
        if (instance == null)
            instance = new ToolProviderNavajo();
        return instance;
    }
    ...
    private synchronized void flush() {
    	if(refToolClassLoader!=null) {
    		refToolClassLoader.clear();
    	}
    }

	public static void flushCompilerCache() {
		if(instance!=null) {
			instance.flush();
		}
