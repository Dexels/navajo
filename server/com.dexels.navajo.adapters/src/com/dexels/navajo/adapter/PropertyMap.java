...
public class PropertyMap implements Mappable {
	 ...
	 *     <map>
        ...
        <object>com.dexels.sportlink.adapters.PropertyMap</object>
        <values>
            ...
            <value name="length" required="true" direction="in"/>
        ...
        <methods>
            <method name="addOption">
                <param name="name"     field="name"      required="true"/>
                <param name="value"    field="value"     required="true"/>
                <param name="selected" field="selected"  required="true"/>
            </method>
        </methods>
    </map>
