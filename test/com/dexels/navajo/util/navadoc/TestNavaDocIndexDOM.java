...
public class TestNavaDocIndexDOM
    extends XMLTestCase {
  ...
  public void testAddEntry() throws ParserConfigurationException,
      FileNotFoundException, IOException,
      SAXException {

    final String s = "TestNavaDocIndexDOM.testAddEntry";
    final DocumentSet dset = (DocumentSet)this.config.getDocumentSetMap().get(
        "Test Project");
    NavaDocIndexDOM dom = new NavaDocIndexDOM(dset);
