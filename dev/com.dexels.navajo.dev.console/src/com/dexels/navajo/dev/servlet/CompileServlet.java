...
public class CompileServlet extends HttpServlet {
    ...
    private final static Logger logger = LoggerFactory.getLogger(CompileServlet.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            bundleCreator.createBundle(script, new Date(), ".xml", failures, success, skipped, force,
            ...
            // bundleCreator.installBundles(script,failures, success, skipped,
            // true,extension);
        ...
        if (req.getParameter("redirect") != null) {
            ...
            resp.getWriter().write(
                    "Succeeded: " + success.size() + " failed: " + failures.size() + " skipped: " + skipped.size());
